...
#SBATCH -t 0-42:00:00
#SBATCH --output /mimer/NOBACKUP/groups/youcan-from-2023-232/users/wivegg/storage/outputs/UA_training.out
...
mkdir $TMPDIR/wivegg/checkpoints/ua
...
export CHECKPOINT_DIR=$TMPDIR/wivegg/checkpoints/ua
export WANDB_NAME=uncertainty-aware-run-7
...
scp -r $TMPDIR/wivegg/checkpoints/ua /mimer/NOBACKUP/groups/youcan-from-2023-232/users/wivegg/storage/outputs/checkpoints
