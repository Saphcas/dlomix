...
# Taken from https://github.com/wilhelm-lab/PROSPECT/blob/main/prospectdataset/process_intensity_data.py
...
download_process_pool(
    annotations_data_dir="prospect_data/Thermo_SRM_Pool/Test",
    metadata_path="prospect_data/Thermo_SRM_Pool_meta_data.parquet",
    pool_name=None,
    save_filepath="prospect_data",
    metadata_filtering_criteria=None,
    parquet_engine="fastparquet"
)